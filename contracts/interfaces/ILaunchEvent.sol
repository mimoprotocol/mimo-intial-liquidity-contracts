...
interface ILaunchEvent {
    ...
    function userMaxAllocation(address account) external view returns (uint256);
    ...
    function pair() external view returns (IMimoPair);

    function ethAllocated() external view returns (uint256);
